      ...
      <div className="containerr  ">
        ...
        <form className="justify-center my-8"  onSubmit={addPhoto}>
          ...
          <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            Secret:
            <input
              className="block w-2/3 p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 lg:w-5/6"
              type="text"
