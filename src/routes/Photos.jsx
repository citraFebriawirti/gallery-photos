      ...
      <div className="containerr">
        <div className="flex justify-center lg:mr-0 lg:justify-between ">
          <select
            ...
            data-testid="sort"
            className="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-20 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500  mr-12 lg:mr-0 lg:w-32"
            style={{}}>
          ...
          <form className="flex items-center"
            ...
            <input
              ...
              className=" self-center bg-gray-50 border border-gray-300 
               text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-25 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500  md:ml-10"/>
